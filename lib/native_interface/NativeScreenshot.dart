...
typedef CaptureScreenFunc = Pointer<Uint8> Function(
    Pointer<Int32> width, Pointer<Int32> height, Pointer<Int32> size);

typedef CaptureScreen = Pointer<Uint8> Function(
    Pointer<Int32> width, Pointer<Int32> height, Pointer<Int32> size);
