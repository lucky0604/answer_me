...
class ChatSettings extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    _focusNode.addListener(() {
      if (!_focusNode.hasFocus) {
        controller.currentChat.update((val) {
          ...
          historyController.updateChatName(
              val.id, controller.name_controller.text);
        });
    ...
    controller.description_controller.text =
    ...
    return Container(
      decoration: const BoxDecoration(
          border: Border(
              left: BorderSide(color: Color.fromARGB(255, 246, 246, 246)))),
      child: Column(children: [
              ...
              onPressed: () {
                Util.pickAndSaveImage().then((value) {
                  ...
                  Util.writeFile(
                      ...
                      jsonEncode(controller.currentChat.value));
                  historyController.updateChatAvatar(
                      controller.currentChat.value.id, value);
                });
              },
              shape: const CircleBorder(),
              child: Avatar(
                filePath: controller.currentChat.value.avatar,
                size: 80,
              )),
          Positioned(
              bottom: 0,
        ...
        Obx(() => Text(controller.currentChat.value.name,
            style: TextStyle(
              fontSize: 20,
              fontWeight: FontWeight.bold,
            ))),
        Text(controller.currentChat.value.subtitle,
          ...
          MaterialButton(
              onPressed: () {
                showDialog(
                    ...
                    builder: (BuildContext context) {
                      return AlertDialog(
                          title: const Text('Please describe the system role'),
                          content: SizedBox(
                              height: 400,
                              child: TextField(
                                  decoration: InputDecoration(
              ...
              - Equipped with cross-cultural communication awareness to understand and adapt to diverse cultural contexts in interactions.
                          ...
                          actions: <Widget>[
                            TextButton(
                                onPressed: () {
                                  controller.currentChat.value.system =
                                      controller.system_controller.text;
                                  Util.writeFile(
                                      'chats/${controller.currentChat.value.id}.json',
                                      jsonEncode(controller.currentChat.value));
                    ...
                    child: Container(
                        ...
                        child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                  controller.currentChat.value.system.isEmpty
                                      ? 'Unset'
                                      : 'Already set',
                    ...
                    child: Column(
                        ...
                        children: [
                          ...
                          Slider(
                              ...
                              max: 1,
                              divisions: 10,
                              label: controller.currentChat.value.temperature
                                  .toString())
                        ])))
          ]),
          Divider(height: 1, color: Colors.grey.withOpacity(0.1)),
                ...
                child: Container(
                    ...
                    child: Column(
                        ...
                        children: [
                          Container(
                              padding: const EdgeInsets.only(left: 10),
                              child: const Text('Dialog Round',
                                  style: TextStyle(
                                      fontSize: 12,
                                      fontWeight: FontWeight.normal))),
                          Slider(
                              value: controller.currentChat.value.dialogCount
                                  .toDouble(),
                              onChanged: (value) {
                                controller.currentChat.update((val) {
                              ...
                              max: 30,
                              divisions: 29,
                              label: controller.currentChat.value.dialogCount
                                  .toString())
                        ])))
          ]),
          Divider(height: 1, color: Colors.grey.withOpacity(0.1)),
